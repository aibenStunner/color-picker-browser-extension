...
const showColors = () => {
  // generation li for the picked color and adding it to the color list
  ...
  // add a click event listener to each color element to copy the color
...
const activateEyeDropper = () => {
  ...
  setTimeout(async () => {
    try {
      ...
      // adding the color to the list, without any duplication!
